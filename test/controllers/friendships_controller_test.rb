...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { confirmed: @friendship.confirmed, invitee_id: @friendship.invitee_id, inviter_id: @friendship.inviter_id } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { confirmed: @friendship.confirmed, invitee_id: @friendship.invitee_id, inviter_id: @friendship.inviter_id } }
